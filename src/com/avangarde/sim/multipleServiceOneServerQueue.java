 ...
 * obtenga:	 
 * a. La hora en que el empleado se va a su casa b. ¿Cuál es el valor estimado
 * de las utilidades diarias? c. ¿Cuál es el tiempo promedio que un cliente
 * tiene que esperar para ser atendido? d. ¿Qué pasa si el tiempo entre llegadas
 * es de 1.5 min/cliente? e. ¿Cuántos empleados debe tener el almacén si el
 * propietario desea que no haya más de dos clientes esperando ser atendidos? "	 *
 *
 * *
 * @author zergio
 */
